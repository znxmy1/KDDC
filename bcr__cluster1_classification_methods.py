...
# kmer2
cluster_kmer = pd.read_csv('bcr_cluster1_kmer_4.csv')
...
print(y_class)
#kmer2_kmer3
# cluster_kmer=pd.read_csv('bcr_cluster1_kmer_2.csv')
# cluster_kmer2 = pd.read_csv('bcr_cluster1_kmer_3.csv')
# cluster_kmer=cluster_kmer.set_index('sample')
# cluster_kmer_1=cluster_kmer.T
# cluster_kmer_1=cluster_kmer_1.div(cluster_kmer_1.sum(axis=1),axis=0)
# cluster_kmer_1['class']=cluster_kmer_1.index
...
#kmer2_kmer4
# cluster_kmer=pd.read_csv('bcr_cluster1_kmer_2.csv')
# cluster_kmer2 = pd.read_csv('bcr_cluster1_kmer_4.csv')
# cluster_kmer=cluster_kmer.set_index('sample')
# cluster_kmer_1=cluster_kmer.T
# cluster_kmer_1=cluster_kmer_1.div(cluster_kmer_1.sum(axis=1),axis=0)
# cluster_kmer_1['class']=cluster_kmer_1.index
...
###kmer3_kmer4
# cluster_kmer=pd.read_csv('bcr_cluster1_kmer_3.csv')
# cluster_kmer2 = pd.read_csv('bcr_cluster1_kmer_4.csv')
# cluster_kmer=cluster_kmer.set_index('sample')
# cluster_kmer_1=cluster_kmer.T
# cluster_kmer_1=cluster_kmer_1.div(cluster_kmer_1.sum(axis=1),axis=0)
...
# cluster_kmer=pd.read_csv('bcr_cluster1_kmer_2.csv')
# cluster_kmer2 = pd.read_csv('bcr_cluster1_kmer_3.csv')
# cluster_kmer3 = pd.read_csv('bcr_cluster1_kmer_4.csv')
#
# cluster_kmer=cluster_kmer.set_index('sample')
# cluster_kmer_1=cluster_kmer.T
# cluster_kmer_1=cluster_kmer_1.div(cluster_kmer_1.sum(axis=1),axis=0)
...
for threshold in range(60, 101, 1):  # 修改为101，以包括100
