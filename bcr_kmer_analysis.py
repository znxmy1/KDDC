...
folder_path='D:/immune repertoire/BCR/bcr_cell/cluster1'
...
result_df.to_csv('tcr_cluster1_kmer_2.csv',index=True)
result_df.to_csv('tcr_cluster1_kmer_3.csv',index=True)
result_df.to_csv('tcr_cluster1_kmer_4.csv',index=True)
